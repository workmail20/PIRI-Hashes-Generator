...
{
    public partial class SecretInput : Form
    {
        public string SecretWords = "";
        public SecretInput(FontFamily f)
        {
            InitializeComponent();
        ...
        {
            SecretWords = textBox1.Text;
            SecretWords = SecretWords.TrimStart(new char[3] { '\r', '\n', ' ' });
            SecretWords = SecretWords.TrimEnd(new char[3] { '\r', '\n', ' ' });
            this.Close();
        }
        ...
        private void SecretInput_Load(object sender, EventArgs e)
        {
